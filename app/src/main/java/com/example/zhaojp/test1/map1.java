 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class map1 extends Activity implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener {
    // 浏览路线节点相关
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(map1.this);
        popupText.setBackgroundResource(R.drawable.box);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.navigation:
                ...
                builder.setView( new EditText( map1.this ) );
