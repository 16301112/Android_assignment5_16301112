 ...
 * {@link allClass.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link allClass#newInstance} factory method to
...
public class allClass extends Fragment {
    ...
    public static allClass newInstance(String param1, String param2) {
        allClass fragment = new allClass();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_all_class, container, false);

        RecyclerView mRecyclerView;

        mRecyclerView =view.findViewById(R.id.class_list);
